...
# 定义任务的名称
export NAME_SPACE=e2e_lu_sample_model
# 定义bert model 路径
...
cp ./e2e_lu_sample_data/*_labels.txt ${NAME_SPACE}
cp ./e2e_lu_sample_data/*_data.json ${NAME_SPACE}

python bert_e2e_lu_joint_domain_intent.py   \
