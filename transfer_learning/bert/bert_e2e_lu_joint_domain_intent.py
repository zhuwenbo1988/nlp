...
class InputExample(object):
    ...
    def __init__(self, guid, text, domain_intent_label=None, slot_label=None):
...
class InputFeatures(object):
    ...
    def __init__(self, input_ids, input_mask, segment_ids, domain_intent_label_id, slot_label_ids):
...
class E2eLuProcessor(DataProcessor):
    ...
    def get_labels(self):
        ...
        return domain_intent_labels, slot_labels
    ...
    def _create_example(self, lines, set_type):
        ...
        for (i, line) in enumerate(lines):
            ...
            examples.append(InputExample(guid=guid, text=text, domain_intent_label=domain_intent_label, slot_label=slot_label))
        return examples
        ...
        if mode == tf.estimator.ModeKeys.PREDICT:
            ...
            if FLAGS.do_export:
                ...
                signature = tf.saved_model.signature_def_utils.predict_signature_def(
                    inputs={"input_ids": input_ids, "input_mask": input_mask, "segment_ids": segment_ids}, outputs={"domain_intent_result": domain_intent_prob, "slot_result": slot_pred_ids})
...
def main(_):
    ...
    domain_intent_labels, slot_labels = processor.get_labels()
    ...
    if FLAGS.do_train:
        ...
        if data_config.get('train.tf_record_path', '') == '':
            ...
            filed_based_convert_examples_to_features(
                train_examples, domain_intent_labels, slot_labels, FLAGS.max_seq_length, tokenizer, train_file)
        else:
    ...
    if FLAGS.do_eval:
        ...
        if data_config.get('eval.tf_record_path', '') == '':
            ...
            filed_based_convert_examples_to_features(
                eval_examples, domain_intent_labels, slot_labels, FLAGS.max_seq_length, tokenizer, eval_file)
    ...
    if FLAGS.do_predict:
        ...
        filed_based_convert_examples_to_features(predict_examples, domain_intent_labels, slot_labels,
        ...
        for true_data, pred in zip(predict_examples, pred_result):
            ...
            print(domain_intent_label)
            print(' '.join(pred_slot_labels_simple))
            print('-----')
