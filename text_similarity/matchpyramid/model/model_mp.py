...
class Model():
    ...
    def __init__(self, config):
        ...
        self.embedding = tf.get_variable('embedding', initializer=config['embedding'], dtype=tf.float32, trainable=True)
        ...
        print "cross_img", self.cross_img
        ...
        print "conv1_expand", self.conv1_expand
    ...
    def train_step(self, sess, feed_dict, merged_summary):
