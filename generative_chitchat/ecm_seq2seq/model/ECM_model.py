...
from utils import SOS_ID, EOS_ID
    ...
    def build_model(self):
        ...
        with tf.variable_scope('seq2seq_decoder'):
            ...
            decoder_cell = ECMWrapper(cell=decoder_cell,
                                      ...
                                      emo_cat_embs=emo_cat_embs,# emotion category embedding table
                                      emo_cat=emo_cat,  # emotion category id
                                      emo_internal_memory_units=self.emo_internal_memory_units,
                                      emo_internal_memory_embedding=self.emo_internal_memory_embedding,  # emo_internal_memory_embedding table
            ...
            emo_choice_layer = tf.layers.Dense(
                1, use_bias=False, name="emo_choice_alpha")  # 选择情感词的概率 projection
            ...
            if self.mode == 'train':
                ...
                self.decoder_logits_train = self.decoder_outputs.rnn_output
                ...
                losses = self.g_losses * (1 - self.choice_qs) + self.e_losses * self.choice_qs  # choice相当于mask
