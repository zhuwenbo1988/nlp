...
from models.model_helper import TopicalBatchedInput as BatchedInput
...
def get_iterator(dataset,
    ...
    def tokenize(line):
        delimited_line = tf.string_split([line], delimiter=vocab.SEPARATOR_SYMBOL).values
        ...
        return aggregated_src, tgt[:tgt_max_len] if tgt_max_len else tgt, tf.string_split([topics[0]]).values
